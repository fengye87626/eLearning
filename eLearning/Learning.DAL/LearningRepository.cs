...
namespace Learning.DAL
{
    ...
    /// That design pattern is called Dependency Injection, in simple words it means that objects do not create other objects on which they rely to do their work. Instead, they get the objects that they need from an outside source.
    /// </summary>
    public class LearningRepository : ILearningRepository
    {
        ...
        .Include("CourseSubject")
        .Include("CourseTutor")
        .Where(c => c.Id == courseId & c.Enrollments.Any(s => s.Course.Id == courseId))
        .SingleOrDefault();
        }
    }
}
